                  ...
                  <tr key={b.id} className="border-t border-gray-100">
                    ...
                    <td className="px-4 py-3 text-gray-700">
                      <div className="text-xs">
                        <div>Start: {b.startDate ? new Date(b.startDate).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) : "-"}</div>
                        <div>End: {b.endDate ? new Date(b.endDate).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) : "-"}</div>
                      </div>
                    </td>
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2 flex-wrap">
