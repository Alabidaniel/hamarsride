...
CREATE TABLE `order` (
  ...
  `status` enum('pending','accepted','picked_up','processing','delivered','rejected','cancelled') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  ...
  `dropoff` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
