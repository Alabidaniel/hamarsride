...
export default function How() {
  return (
    <section className="bg-[#f3ebe0] px-4 py-18 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-6xl">
        <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
          <div>
            ...
            <p className="mt-4 max-w-xl text-base leading-7 text-[#72604f]">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-1">
            {steps.map((step) => (
              <article
                key={step.number}
                className="rounded-3xl bg-[#fffdf9] p-6 shadow-sm ring-1 ring-[#e5d7c7]"
              >
                <div className="flex items-start gap-4">
                  <div className="min-w-14 rounded-2xl bg-[#8a684d] px-3 py-2 text-center text-sm font-bold text-[#fffaf4]">
                    {step.number}
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold text-[#2f241b]">{step.title}</h3>
                    <p className="mt-2 text-sm leading-6 text-[#72604f]">{step.description}</p>
                  </div>
                </div>
              </article>
            ))}
