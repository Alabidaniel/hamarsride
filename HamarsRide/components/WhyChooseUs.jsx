...
export default function WhyChooseUs() {
  return (
    <section className="bg-orange-600 px-4 py-18 text-white sm:px-6 lg:px-8">
      <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[1fr_1fr] lg:items-center">
        <div>
          <p className="text-sm font-semibold uppercase tracking-[0.35em] text-orange-50/90">
            Why HamarsRide
          </p>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-1">
          {reasons.map((reason) => (
            ...
            >
              <p className="text-sm leading-6 text-white">{reason}</p>
            </div>
          ))}
        </div>
      </div>
