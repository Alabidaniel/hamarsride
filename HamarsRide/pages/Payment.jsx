    ...
    <div className="min-h-screen bg-white text-gray-900 flex flex-col">
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 flex-1">
        <section className="rounded-[1.5rem] border border-orange-200 bg-white px-5 py-6 shadow-sm sm:px-6">
          <p className="text-xs font-semibold uppercase tracking-[0.26em] text-orange-600">Final Step</p>
        ...
        <div className="mt-5 grid grid-cols-1 gap-6 lg:grid-cols-[minmax(0,1.2fr)_minmax(320px,0.8fr)]">
          <section className="rounded-2xl border border-orange-200 bg-white p-5 sm:p-6 shadow-sm">
            <h2 className="text-xl font-semibold">Bank transfer details</h2>

            {isLoading ? (
              <div className="mt-4 text-sm text-gray-500">Loading payment instructions...</div>
            ) : (
            ...
            <div className="mt-5 rounded-xl border border-orange-200 bg-orange-50 p-4">
              ...
              <div className="mt-3 rounded-xl border border-dashed border-orange-200 bg-white p-4">
                ...
                {receiptFile ? (
                  ...
                  <p className="text-xs text-gray-500 mt-2">Upload a receipt to continue.</p>
                )}
              </div>
            </div>
          </section>

          <aside className="rounded-2xl border border-orange-200 bg-white p-5 sm:p-6 shadow-sm h-fit">
            ...
            <div className="mt-4 rounded-xl border border-orange-200 bg-orange-50 p-3 text-sm text-gray-700">
            ...
            <button
              ...
              className="mt-2 w-full border border-orange-200 bg-orange-50 text-orange-700 px-6 py-3 rounded-xl font-semibold transition hover:bg-orange-100"
            >
              Back to Checkout
            </button>
          </aside>
...
function PaymentRow({ label, value, onCopy, copied }) {
  return (
    <div className="border border-orange-200 rounded-xl p-4 flex flex-col items-start justify-between gap-3 bg-white sm:flex-row sm:items-center">
      ...
      <button
        onClick={onCopy}
        className="inline-flex w-full items-center justify-center gap-2 rounded-lg border border-orange-200 bg-orange-50 px-3 py-2 text-sm text-orange-700 transition hover:bg-orange-100 sm:w-auto"
      >
