...
export default function LoginPage() {
  ...
  return (
    <div className="bg-yellow-100 w-full min-h-screen flex items-center justify-center px-4 py-10" style={{ fontFamily: "Playfair Display" }}>
      <motion.div
        className="w-full max-w-md bg-orange-600 rounded-3xl shadow-xl p-6 sm:p-8"
